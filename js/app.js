...
function adaptEnvironment() {
  ...
  if (!isLocal) {
    ...
    if (envBadgeText) {
      envBadgeText.textContent = 'GitHub Pages Cloud • Interactive Ecosystem';
    }
